          ...
          <div className="w-full flex flex-col md:w-[50%] gap-y-3 p-4">
            ...
            <div className="w-full flex items-center justify-center flex-col gap-y-2">
              ...
              <span className="font-poppins text-xs">
                ...
                <Link to="/signup">
                  <span className="ml-2 text-green">Signup</span>
                </Link>
              </span>
            </div>
            <form onSubmit={handleLogin}>
              <div className="w-full flex flex-col items-center juistify-center mt-5 gap-y-3">
                ...
                <button
                  type="submit"
                  className="w-full md:w-[90%] xl:w-[80%] 2xl:w-[75%] font-poppins text-sm leading-relaxed px-4 py-2 cursor-pointer bg-green text-white rounded-md text-center mt-2"
                >
                  Login
                </button>
              </div>
